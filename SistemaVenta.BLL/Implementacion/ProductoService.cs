...
namespace SistemaVenta.BLL.Implementacion
{
    public class ProductoService :IProductoService
    {
        ...
        public ProductoService(IGenericRepository<Producto> repositorio, IFirebaseService firebaseService, IUtilidadesService utilidadesService)
        {
        ...
        public async Task<Producto> Crear(Producto entidad, Stream imagen = null, string NombreImagen = "")
        {
            ...
            try
            {
                ...
                if(producto_creado.IdProducto == 0)
                    throw new TaskCanceledException("El Producto no se púdo crear");
